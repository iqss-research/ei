...
test_that("eiread betab works", {
  expect_equal(eiread(dbuf, "betab"),
               c(0.2006, 0.1443, 0.1823, 0.282, 0.1281, 0.1241, 0.0991, 0.1005,
...
test_that("eiread betaw works", {
  expect_equal(eiread(dbuf, "betaw"),
               c(0.691, 0.6503, 0.6247, 0.8849, 0.5671, 0.3791, 0.5289, 0.5585,
...
test_that("eiread phi works", {
  expect_equal(eiread(dbuf, "phi"),
               c(-1.1535, 0.8217, -2.2862, -1.882, 0.4123, 0, 0))
})

test_that("eiread sbetab works", {
  expect_equal(eiread(dbuf, "sbetab"),
               c(0.0965, 0.0442, 0.0949, 0.0737, 0.0678, 0.0842, 0.0536, 0.0547,
...
test_that("eiread sbetaw works", {
  expect_equal(eiread(dbuf, "sbetaw"),
               c(0.0045, 0.1111, 0.0144, 0.064, 0.048, 0.0119, 0.0727, 0.0792,
...
test_that("eiread psisims works", {
  expect_equal(eiread(dbuf, "psisims")[, 1],
               c(0.1848, 0.2167, 0.2089, 0.2394, 0.1937, 0.154, 0.1851, 0.1661,
...
test_that("eiread bounds works", {
  expect_equal(eiread(dbuf, "bounds"),
               structure(c(0, 0.0051, 0, 0.1495, 0, 0, 0, 0, 0, 0, 0, 0, 0,
...
test_that("eiread CI80b works", {
  expect_equal(eiread(dbuf, "CI80b"),
               structure(c(0.0914, 0.0815, 0.0641, 0.1971, 0.0427, 0.026, 0.0388,
...
test_that("eiread CI80w works", {
  expect_equal(eiread(dbuf, "CI80w"),
               structure(c(0.6852, 0.5196, 0.6069, 0.7867, 0.5066, 0.3621, 0.4213,
...
test_that("eiread abounds works", {
  expect_equal(eiread(dbuf, "abounds"),
...
test_that("eiread aggs works", {
  expect_equal(eiread(dbuf, "aggs"),
               structure(c(0.1812, 0.2168, 0.2115, 0.2296, 0.1937, 0.1836, 0.1903,
...
test_that("eiread maggs works", {
  expect_equal(eiread(dbuf, "maggs"),
               c(0.2018, 0.7192, 0.0114, 0.009)
  )
})

test_that("eiread VCaggs works", {
  expect_equal(eiread(dbuf, "VCaggs"),
...
test_that("eiread goodman works", {
  expect_equal(eiread(dbuf, "goodman"),
               structure(c(0.1956, 0.7228, 0.0275, 0.023, 7.0995, 31.3996, 0, 0),
                         .Dim = c(2L, 4L),
                         .Dimnames = list(c("BetaB", "BetaW"),
