...
test_that("`ei()` 2x2", {
  ...
  expect_equal(dbuf_summary[[6]][2, 5], 0.5044172, tolerance = 0.01)

  expect_equal(dbuf_summary[[7]][2], 1.813881, tolerance = 0.01)
  ...
  expect_equal(dbuf_summary[[10]][1, 1], 0.8070165, tolerance = 0.001)
  expect_equal(dbuf_summary[[10]][2, 2], 0.0006221812, tolerance = 0.01)
})
