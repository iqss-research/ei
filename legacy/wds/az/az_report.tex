...
could have been drawn.  We perform these analysess for both the
...
explains the methodology (Section \ref{s:methods})
...
\subsection{Estimating Ethnic Group Voting Behavior Despite the Secret Ballot}\label{s:ei}
...
\bibliography{az_bib,gk,gkpubs}
\end{document}

% Ben:*************************************************************
% move all below to the LD report?
% *****************************************************************
