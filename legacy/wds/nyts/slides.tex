...
\heading{Late Domestic Postmark: Example 1}

\includegraphics[width=4.5in,height=3in]{latepost1}
...
\heading{Late Domestic Postmark: Example 2}

\includegraphics[width=4.5in,height=3in]{latepost2}
...
\heading{Witness's Signiture Missing: Example 1}

\includegraphics[width=4.5in,height=3in]{witmiss1}
...
\heading{Witness's Signiture Missing: Example 2}

\includegraphics[width=4.5in,height=3in]{witmiss2}
...
\heading{Postmark Missing: Example 1}

\includegraphics[width=4.5in,height=3in]{postmiss1}
...
\heading{Postmark Missing: Example 2}

\includegraphics[width=4.5in,height=3in]{postmiss2}
...
\item Systematic differences in $\bb_i$ and $\bg_i$ are accounted
  for by covariates.
\item No spatial correlation, conditional on covariates.
\item $\bb_i$ and $\bg_i$ are independent, conditional on covariates.
  of $X_i$. 
\end{itemize}
...
\begin{itemize}
\item Sensitivity to model specification when bounds are wide.
\item Cannot include many covariates in one model.
\end{itemize}
...
\item Need to build models less vulnerable to criticism from partisans.
\end{itemize}
