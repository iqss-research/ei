...
{\bf I{\sc LLEGAL} B{\sc ALLOTS} I{\sc N} F{\sc LORIDA}:} 
\begin{itemize}
...
{\bf E{\sc COLOGICAL} I{\sc NFERENCE} W{\sc ITH} B{\sc AYESIAN} M{\sc
    ODEL} A{\sc VERAGING}:} 
...
{\bf Data and Model:} 31 models using covariables including $X_i$,
...
\item It is different from an idiosyncratic measure of fit such as $R^2$.
...
\item {\bf Methodological contributions:} 
  \begin{itemize}
  ...
  \item A solution to the uncertainty of model choice.
