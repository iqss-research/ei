...
\item {\it It would also be valuable simply to say outright that it
  ...
  Moreover, our given task was to produce an estimate of the
  probability of a Gore victory without making implicit assumptions,
  in as scientific a way as possible.
\end{enumerate}
...
\clearpage
\begin{center}
  {\bf \Large Point-By-Point Reply to the Asociate Editor}
\end{center}
