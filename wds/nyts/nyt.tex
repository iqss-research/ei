...
intensive models (each taking about a day of computer time) had large
enough estimated weights to be meaningful, including these in the
Bayesian model averaging procedure did not appreciably change our
...
is possible that future researchers might find and include a model we
...
Bayesian model averaging results are better than any individual model
among those we average over, but they could very well be overturned if
someone finds a plausible model to add that turns out to have a high
probability of being correct and leads to different inferences. 
