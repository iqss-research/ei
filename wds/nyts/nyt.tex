...
\citep{raft:96,lewi:raft:97,dici:kass:raft:wass:97}.\footnote{If a
  ...
  $O(1/\sqrt{n})$: For example, Kass and Raftery (1995,p.778) say that
  ``even for very large samples, it [BIC] does not produce the correct
  value.''  In our small-$n$ application, the Laplace approximation
  along with exact finite sample posterior simulation is more
  appropriate.}
