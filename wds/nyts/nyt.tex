...
conditioning on $T_i$) fits by comparing the county-level predictive
confidence interval for $T_i$ to its observed value.  Figure
\ref{fg:fit} gives several examples of this strategy for two of the
models we ran (in the first two rows), as well as for the ultimate
