...
\emph{Bush v.\ Gore} seemed to require for votes cast on election
day), the bad ballots might very well have been disqualified.  In this
...
parameters to be estimated and $\bar{Z}_i^{\text{good}}$ and
$\bar{Z}_i^{\text{bad}}$ are means of the covariate vectors.  This
