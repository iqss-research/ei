...
comparative neglect by the Democrats.\footnote{The Democrats had
  ...
  Gore then backed him up and the Democrats left the Republicans
  strategies unchallenged.  See Berke (2001).}  They concluded that
...
The 680 ballots that the \emph{Times} found were flawed met one or
more of these conditions (Barstow and Van Natta, Jr.,
...
marginal likelihood would be exactly the likelihood for the model
(rather than a parameter of the model) if the data turn out to look
exactly like your prior.  Hence, the marginal likelihood tells us how
well each model would be supported by the prior.  We discuss
