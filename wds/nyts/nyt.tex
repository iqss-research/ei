...
inference, but much can be done.  Our approach, in addition discussing
the bounds, is to introduce formal Bayesian model averaging procedures
and to include a wide range of models that any partisan might have
...
introduced here in the program \emph{EI: A Program for Ecological
  Inference} (available at \url{http://GKing.Harvard.edu}).
