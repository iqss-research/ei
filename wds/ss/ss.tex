...
filling in this missing information leads back to the suggestions from
...
occur when the estimated points are near zero or one) without making any
...
not exactly parallel because HS is calculated conditional on
...
\begin{figure}[t]
  \begin{center}
    ...
    \caption{Data with Wide Bounds. Plot of $Z_i$ horizontally by
      ...
      \textrm{Normal}(0.5,0.01)$, $\breve\bbeta_i^b = Z_i - 0.1$,
