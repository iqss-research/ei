...
$\gamma_R=1$).\footnote{Under the first interpretation of the HS Monte
  Carlo setup, $E(\beta_i^b)=\alpha_R+\gamma_R Z_i$, where
...
second interpretation is also inappropriate for assessing a dependent
...
approximations,\footnote{That is, under the third interpretation
