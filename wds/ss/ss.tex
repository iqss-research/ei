...
squares corrects most of the problems they raise.  We show how filling
in this missing information leads back to the suggestions from the
...
and Shots would have used if they had done so.\footnote{Indeed, after
  ...
  took it out in the final version.}  This fully adjusted second stage
regression method dominates the slope-only procedure and indeed the
partially adjusted procedure in HS is never called for.
...
a researcher can easily detect which situation she is in from the
available aggregate data, she can always take appropriate action.
