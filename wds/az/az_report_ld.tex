...
\title{An Analysis of the Arizona Independent Redistricting Commission
  Legislative District Map\thanks{A web appendix to this report can be
    found at \url{j.mp/az-doj}.  The methods section of this report
    (Section 2) overlaps with that from our other report, ``An
    Analysis of the Arizona Independent Redistricting Commission
...
Overall, we find that the new voting rights districts have similar
levels of racially polarized voting between the baseline and new
plans, although there are some differences across the state within
each set of districts.  On the basis of the quantitative information
we have used, it seems straightforward to identify the candidate of
choice of the Hispanic community in all but a few districts and most
of the new districts would seem to have the ability to elect these
candidates.  We also find that it would be difficult, and unnecessary
if it were possible, to draw districts more favorable to minorities.
We see no evidence of retrogression.
...
For each graph in Figure~\ref{cvap_ld}, the horizontal axis displays
the estimated two-party vote share for the candidate of choice among
the main minority population. The vertical axis represents the
observed two-party vote share for the candidate of choice in the
district. Thus, when a district falls in the top right quadrant of a
graph it means that that the main minority in the district prefers the
candidate of choice and the district as a whole would have elected the
candidate of choice.
...
voters choose to sort themselves among electoral precincts.
...
is not clear. Importantly, this is not a problem with how the district
has been drawn; rather, it is just a product of how people vote and
where people live in the district. Despite these caveats, however, the
...
A final point of concern might be whether the proposed map will
adversely affect incumbent candidates of choice in state legislative
elections. We have shown that the proposed maps are not retrogressive
when considering candidates of choice who are themselves minorities or
(as in the 2004 US President Election) Democrats. This approach raises
the question of how to treat candidates who belong to a minority
racial group and are also Republicans. However, we have concluded that
this appears not to be of great concern because our estimates suggest
that such candidates are not the clear candidates of choice in the
first place. For example, the Hispanic Republican Jesse Hernandez (LD
17) was not the clear candidate of choice among Hispanic voters in
either 2004 or 2008. Tables~\ref{stsen04_cvap_ld_17} and
\ref{stsen08_cvap_ld_17} suggest that Hernandez received less than
half of the vote share among Hispanic voters in both
elections.\footnote{This comes with the caveat that these estimates
  are relatively uncertain, as is evident from an examination of the
  tomography plots displaying the Hispanic vote for Hispanic candidate
  included in the digital appenix.}
