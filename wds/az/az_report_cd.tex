...
testimony from 1953 until 1997 when \citeauthor{King97}'s EI
...
in the same model.  For example, \citet{RosJiaKin01} extends King's
...
geographically adjacent districts.  In our version, we assume that
...
\caption{This tomography plot displays the white vote for the Hispanic
  Candidate in 2010 Mine Inspector Election (horizontally) by
  non-white vote for the same election (vertically)}
\end{centering}
\label{tomog}
\end{figure}
...
will be seen in our analysis of Arizona's legislative districts, it is often
...
\section{Ecological Inference Estimates: CVAP}
\subsection{Proposed Districts}

\input{figs/smine_cvap_cd_3}
\input{figs/smine_cvap_cd_7}

\input{figs/pres04_cvap_cd_3}
\input{figs/pres04_cvap_cd_7}

\input{figs/pres08_cvap_cd_3}
\input{figs/pres08_cvap_cd_7}

\input{figs/sos06_cvap_cd_3}
\input{figs/sos06_cvap_cd_7}

\input{figs/sos10_cvap_cd_3}
\input{figs/sos10_cvap_cd_7}

\newpage
\clearpage
\subsection{Benchmark Districts}


\input{figs/smine_cvap_cd_4_benchmark}
\input{figs/smine_cvap_cd_7_benchmark}

\input{figs/pres04_cvap_cd_4_benchmark}
\input{figs/pres04_cvap_cd_7_benchmark}

\input{figs/pres08_cvap_cd_4_benchmark}
\input{figs/pres08_cvap_cd_7_benchmark}

\input{figs/sos06_cvap_cd_4_benchmark}
\input{figs/sos06_cvap_cd_7_benchmark}

\input{figs/sos10_cvap_cd_4_benchmark}
\input{figs/sos10_cvap_cd_7_benchmark}
