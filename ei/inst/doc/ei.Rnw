...
\section[ei parametric: Estimation for 2x2 tables]{{\tt ei parametric}: Estimation for 2x2 tables}
\label{eip}
...
\subsection[ei parametric: Demos]{{\tt ei parametric}: Demos}
\label{eipdemos}
...
\subsection[ei parametric: Example]{{\tt ei parametric}: Example}
...
\section[ei non-parametric: Estimation for 2x2 tables]{{\tt ei non-parametric}: Estimation for 2x2 tables}
\label{einp}
...
\subsection[ei non-parametric: Demos]{{\tt ei non-parametric}: Demos}
\label{einpdemos}
...
\subsection[ei non-parametric: Example]{{\tt ei non-parametric}: Example}
\label{einpxample}
