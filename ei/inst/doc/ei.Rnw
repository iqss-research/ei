...
\title{EI: A(n R) Program for Ecological Inference}
...
Street, Harvard University, Cambridge MA 02138;
  ...
  495-2027.} \and Margaret Roberts \thanks{Department of Government, 1737 Cambridge Street, Harvard Univeristy, Cambridge MA 02138}}
...
\textbf{A Solution to the Ecological Inference Problem: 
...
We recommend reviewing Chapter 16 while using this program for actual research.
